...
const validConfigs = [
  ...
  [{ version: '1', rules: [{ base: 'master', upstream: 'upstream:master', autoMerge: true, assignees: ['khulnasoft-labs'] }] }],
  [{ version: '1', rules: [{ base: 'master', upstream: 'upstream:master', autoMerge: false, reviewers: ['khulnasoft-labs'] }] }],
  [{ version: '1', rules: [{ base: 'master', upstream: 'upstream:master', autoMerge: false, reviewers: ['khulnasoft-labs'], conflictReviewers: ['saurabh702'] }] }],
  [{ version: '1', rules: [{ base: 'master', upstream: 'upstream:master', mergeMethod: 'squash', mergeUnstable: true }] }],
  [{ version: '1', rules: [{ base: 'master', upstream: 'upstream:master', mergeMethod: 'hardreset', assignees: ['khulnasoft-labs'] }] }],
  [{
    version: '1',
    rules: [
  ...
  [{
    version: '1',
    rules: [
      { base: 'master', upstream: 'upstream:master', autoMerge: true, autoMergeHardReset: true, assignees: ['khulnasoft-labs'] },
      { base: 'development', upstream: 'upstream:development', autoMerge: false, autoMergeHardReset: true, reviewers: ['khulnasoft-labs'] },
      { base: 'development', upstream: 'upstream:development', autoMerge: false, autoMergeHardReset: true, reviewers: ['khulnasoft-labs'], conflictReviewers: ['saurabh702'] }
    ],
    label: 'pull',
